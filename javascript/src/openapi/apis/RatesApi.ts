...
export class RatesApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async v1RatesEstimate(baseAmount: string, baseCurrency: string, toCurrency: string, _options?: Configuration): Promise<RequestContext> {
     ...
     */
    public async v1RatesList(request: GetRatesRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new RequiredError('Required parameter request was null or undefined when calling v1RatesList.');
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(request, "GetRatesRequest", ""),
            contentType
        );
