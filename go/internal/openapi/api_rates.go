...
func (r ApiV1RatesEstimateRequest) Execute() (EstimateResponse, *_nethttp.Response, error) {
	return r.ApiService.V1RatesEstimateExecute(r)
}

/*
 * V1RatesEstimate Estimates
 * Estimates currency exchange amounts.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param appId App ID
 * @return ApiV1RatesEstimateRequest
 */
func (a *RatesApiService) V1RatesEstimate(ctx _context.Context, appId string) ApiV1RatesEstimateRequest {
	return ApiV1RatesEstimateRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
 ...
 */
func (a *RatesApiService) V1RatesEstimateExecute(r ApiV1RatesEstimateRequest) (EstimateResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RatesApiService.V1RatesEstimate")
	if err != nil {
...
func (r ApiV1RatesListRequest) Execute() (GetRatesResponse, *_nethttp.Response, error) {
	return r.ApiService.V1RatesListExecute(r)
}

/*
 * V1RatesList List rates
 * Query the latest exchange rates between different currencies.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param appId App ID
 * @return ApiV1RatesListRequest
 */
func (a *RatesApiService) V1RatesList(ctx _context.Context, appId string) ApiV1RatesListRequest {
	return ApiV1RatesListRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
 ...
 */
func (a *RatesApiService) V1RatesListExecute(r ApiV1RatesListRequest) (GetRatesResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RatesApiService.V1RatesList")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
