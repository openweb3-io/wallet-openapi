...
const (
	TRANSACTIONSTATUS_TransactionStatusProcessing TransactionStatus = "PROCESSING"
	TRANSACTIONSTATUS_TransactionStatusCanceled TransactionStatus = "CANCELED"
	TRANSACTIONSTATUS_TransactionStatusFailed TransactionStatus = "FAILED"
	TRANSACTIONSTATUS_TransactionStatusSucceed TransactionStatus = "SUCCEED"
)
